...
import static my.util.LemmaUtil.aImplALemma;
import static my.util.LogicUtil.createMapping;
import static my.util.LogicUtil.createReplacing;

public class PropositionalCalculus extends Theory {
    private static PropositionalCalculus INSTANCE;

    public static PropositionalCalculus getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new PropositionalCalculus(new SimpleParser(),
                    first, second, third, fourth, fifth, sixth, seventh, eighth, ninth, tenth);
        }
        return INSTANCE;
    }

    private PropositionalCalculus(LogicalParser parser, PreAxiom... axioms) {
        super(parser, axioms);
    }
